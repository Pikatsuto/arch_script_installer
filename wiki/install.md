...
```
pacstrap /mnt base base-devel pacman-contrib linux linux-firmware linux-zen linux-headers linux-zen-headers nano vim dhcpcd dhclient networkmanager grub os-prober efibootmgr zip unzip p7zip alsa-utils syslog-ng mtools dosfstools lsb-release ntfs-3g exfat-utils bash-completion
```
